...
function Bubble2(props) {
  ...
  return (
    <div className="bubble-3" style={{ backgroundImage: `url(${bubble})` }}>
      ...
      <div className="overlap-group6-106">
        <div className="seat-left-33 inter-thin-black-8px">
        ...
        <div className="are-going-39 inter-thin-black-8px">{areGoing}</div>
      </div>
      <div className="ellipse-1-58 border-1px-black"></div>
    </div>
  );
}
