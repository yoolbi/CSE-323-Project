  ...
  return (
    <div className="container-center-horizontal">
      <div className="iphone-13-home-suhyun-chun screen">
        <div className="group-container-250 applesdgothicneo-regular-normal-flamingo-12px">
          <div className="overlap-group10-46">
            <div className="list-2">{list}</div>
            <Link to="/yool-bi-pilteo-gyeolgwa-eobseul-ddae">
              <img className="vector-893" src="/img/vector-2@2x.png" />
            </Link>
          </div>
          <div className="overlap-group11-25">
            <div className="rectangle-15-39"></div>
            <img className="icon-search-39" src={iconSearch} />
          </div>
          <div className="overlap-group12-12">
            <div className="my-2">{my}</div>
            <Link to="/completed-preorder-home">
              <img className="group-111" src={group1} />
            </Link>
          </div>
          <img className="group-112" src={group2} />
        </div>
        <Component94 {...component94Props} />
        <div className="overlap-group9-64" style={{ backgroundImage: `url(${overlapGroup9})` }}>
          <div className="flex-row-625">
            <Bubble {...bubbleProps} />
          ...
          <div className="overlap-group15-1">
            <img className="icon-location_pin-8" src={iconLocation_Pin} />
          ...
          <img className="vector-894" src={vector2} />
        </div>
      </div>
    </div>
  );
